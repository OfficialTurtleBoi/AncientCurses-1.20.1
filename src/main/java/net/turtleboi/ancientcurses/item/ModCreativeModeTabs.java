    ...
    public static final RegistryObject<CreativeModeTab> ANCIENTCURSES_TAB = CREATIVE_MODE_TABS.register("ancientcurses_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.GOLDEN_AMULET.get()))
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(ModItems.ICE_SPARK.get());
                        pOutput.accept(ModItems.PLAGUE_IDOL.get());
                        pOutput.accept(ModItems.VOODOO_DOLL.get());
                        pOutput.accept(ModItems.FATHOMLESS_CAULDRON.get());
                        pOutput.accept(ModItems.HOLLOW_LANTERN.get());
                        pOutput.accept(ModItems.BONE_FLUTE.get());
                        pOutput.accept(ModItems.ECHO_STONE.get());
                        pOutput.accept(ModItems.GILDED_TOME.get());
                        pOutput.accept(ModItems.SOUL_COMPASS.get());
                        pOutput.accept(ModItems.EXODUS_TOTEM.get());
                        pOutput.accept(ModItems.CRYSTAL_BALL.get());
                        pOutput.accept(ModItems.BLOODPRICE_SIGIL.get());
                        pOutput.accept(ModItems.THORN_CROWN.get());
                        pOutput.accept(ModItems.RUINATION_BRAND.get());
