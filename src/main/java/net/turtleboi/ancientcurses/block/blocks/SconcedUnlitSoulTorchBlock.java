...
public class SconcedUnlitSoulTorchBlock extends TorchBlock {
    public SconcedUnlitSoulTorchBlock(Properties pProperties, ParticleOptions pFlameParticle) {
    ...
    public InteractionResult use(BlockState state, Level level, BlockPos blockPos,
        ...
        if (heldItem.getItem() == Items.FLINT_AND_STEEL) {
            ...
            if (hand == InteractionHand.MAIN_HAND) {
                ...
                Block newBlock = ModBlocks.SCONCED_SOUL_TORCH.get();
