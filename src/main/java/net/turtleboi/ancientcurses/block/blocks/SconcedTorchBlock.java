...
public class SconcedTorchBlock extends TorchBlock {
    public SconcedTorchBlock(Properties pProperties, ParticleOptions pFlameParticle) {
    ...
    public InteractionResult use(BlockState state, Level level, BlockPos blockPos,
        ...
        if (heldItem.isEmpty()) {
            ...
            if (hand == InteractionHand.MAIN_HAND && player.getAbilities().mayBuild) {
                ...
                Block newBlock = ModBlocks.SCONCED_UNLIT_TORCH.get();
